...
/* 0x0C */
void *malloc_checked(unsigned int b);/*0- allocates memory using malloc */
char *string_nconcat(char *s1, char *s2, unsigned int n);/*1- concatenates*/
/*twostrings.*/
void *_calloc(unsigned int nmemb, unsigned int size);/*2- allocates memory */
/* for an array */
int *array_range(int min, int max);/*3- creates an array of integers */
/* advance*/
void *_realloc(void *ptr, unsigned int old_size, unsigned int new_size);/*4- */
/*5- */
